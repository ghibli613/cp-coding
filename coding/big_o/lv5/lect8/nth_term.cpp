...
void solve()
{
    Matrix<mint<MOD>> mat(4, 4);
    
    mat.a[0][1] = mat.a[1][2] = mat.a[3][3] = 1;

    int n; cin >> n;
    cin >> mat.a[2][2] >> mat.a[2][0] >> mat.a[2][3];

    Matrix<mint<MOD>> base(4, 1);
    base.a[0][0] = 0; base.a[1][0] = 0; base.a[2][0] = 0; base.a[3][0] = 1;

    Matrix<mint<MOD>> temp = pow(mat, n) * base;
    cout << temp.a[0][0] << '\n';
}
